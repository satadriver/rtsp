...
string JsonStringValue(string data, string key) {
...
string JsonBaseValue(string data, string key) {
	string findkey = string("\"") + key + "\"";
	int pos = data.find(findkey);
	if (pos >= 0)
	{
...
vector<string>* JsonFromArray(string substr) {
...
vector<string>* JsonFromRoot(string substr) {
...
string JsonQuotaStringValue(string data, string key) {
	string findkey = string("\"") + key + "\"";
	int pos = data.find(findkey);
	if (pos >= 0)
	{
